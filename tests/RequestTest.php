...
class RequestTest extends TestCase
{
    ...
    {
        $body = '{"coverage_type":"MT","id_type":"1","id_value":"850126075149","vehicle_postcode":"50000","vehicle_reg_no":"PJW4741","drivers":[{"email":"sam.aljufri@gmail.com"}],"agent_code":"agent","operator_code":"operator"}';
        ...
        $client = new Client($faker->http(), 'id', 'secret', 'agent', 'operator');

        $client->uses('Quote')->submit([
                'coverage_type' => 'MT',
                'id_type' => '1',
                'id_value' => '850126075149',
                'vehicle_postcode' => '50000',
                'vehicle_reg_no' => 'PJW4741',
                'drivers' => [
